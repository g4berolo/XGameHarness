...
- For general UI implementation, interaction/UX design, localization, and accessibility
  compliance, surface to the user (this roster has no `ui-programmer` / `ux-designer` /
  `localization-lead` / `accessibility-specialist` agents)
