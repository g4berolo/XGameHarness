...
> ⚠️ **Applicability note (READ FIRST)**: If the project is a **single-player** game
...
- For transport-layer networking and network security validation, surface to the user
  (this roster has no `network-programmer` / `security-engineer` agents)
